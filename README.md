...
<a name="WUNDERLANDS" href="https://www.wunderlands.de"><img align="center" src="https://github.com/Vibrantic/wunderlands-master/blob/main/WUNDERLANDS.png" alt="WUNDERLANDS LOGO" style="width:100%;height:100%"/></a>
  ...
  <br /><h2 style="font_size=10px"><i>Copyright (C) 2023 Wunderlands, www.wunderlands.de</i></h2>
</h1>
...
New Biomes: Discover captivating landscapes, from lush forests to desolate deserts and everything in between.
Unique Blocks: Build with style using a variety of fresh building materials and decorative blocks.
Exotic Items: Collect rare and exciting items to craft powerful tools and gear.
Engaging Mechanics: Challenge your skills with new gameplay elements that add depth and excitement to your Minetest world.
